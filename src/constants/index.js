...
export const orgs = {
    "organizations": [
      ...
      },
      {
        "continent": "Global",
        "country": "Global",
        "link": "compassion-aid-save-a-pet",
        "name": "Compassion Aid Save a Pet",
        "goal": "provide vital healthcare, education, and a chance at a better future for children.",
        "purpose": "Compassion Aid Save a Pet works to rescue and provide care for animals in need, ensuring their well-being and promoting responsible pet ownership.",
        "image_url": compassion
      },
      {
        "continent": "Global",
        "country": "Global",
        "link": "compassion-aid-shelter-for-the-homeless",
        "name": "Compassion Aid Shelter for the Homeless",
        "goal": "provide vital healthcare, education, and a chance at a better future for children.",
        "purpose": "Compassion Aid Shelter for the Homeless provides essential support and resources to individuals experiencing homelessness, ensuring access to healthcare, education, and a pathway to a better future.",
        "image_url": compassion
      },
    //   {
    //     "continent": "Europe",
    ...
    //     "purpose": "Oxfam is dedicated to ending poverty by addressing its root causes—economic inequality, lack of access to resources, and social injustices. The organization works with local communities to provide access to clean water, education, and sustainable livelihoods. Oxfam also campaigns for fair trade, gender equality, and climate action to create systemic changes that uplift marginalized groups globally.",
    //     "image_url": Oxfam
    //   },
    //   {
    //     "continent": "Europe",
